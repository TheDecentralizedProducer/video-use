...
PRESETS: dict[str, str] = {
    ...
    # Night shoot / ring light grade — designed for warmer ring light footage shot
    # without natural daylight. Shadow lift stops the background going pure black,
    # smooth highlight rolloff kills ring light harshness, warm color push in shadows
    # simulates ambient room bounce. Also works during daytime with ring light to
    # even out natural light mixing. Natural v3, tested 2026-07-16.
    "night_shoot": (
        "eq=contrast=1.04:brightness=0.02:saturation=0.85,"
        "colorbalance="
        "rs=0.06:gs=0.01:bs=-0.05:"
        "rm=0.03:gm=0.01:bm=-0.02:"
        "rh=0.03:gh=0.01:bh=-0.02,"
        "curves=master='0/0.06 0.20/0.22 0.60/0.63 0.85/0.81 1/0.91'"
    ),
